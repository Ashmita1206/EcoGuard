...
export async function GET() {
  try {
    ...
    // Get detailed agent information (robust to DB/schema issues)
    try {
      ...
      return NextResponse.json({ success: true, data: { agents: formattedAgents } });
    } catch (e) {
      console.error('Error fetching team data (robust):', e);
